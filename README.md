## igvc_self_drive_sim (kinetic) - 0.1.4-1

The packages in the `igvc_self_drive_sim` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release igvc_self_drive_sim --rosdistro kinetic` on `Sun, 07 Oct 2018 03:20:09 -0000`
...
## igvc_self_drive_sim (melodic) - 0.1.4-1

The packages in the `igvc_self_drive_sim` repository were released into the `melodic` distro by running `/usr/bin/bloom-release igvc_self_drive_sim --rosdistro melodic` on `Sun, 07 Oct 2018 03:17:07 -0000`
...
## igvc_self_drive_sim (kinetic) - 0.1.4-0

The packages in the `igvc_self_drive_sim` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release igvc_self_drive_sim --rosdistro kinetic` on `Sun, 07 Oct 2018 03:09:22 -0000`
...
## igvc_self_drive_sim (melodic) - 0.1.4-0

The packages in the `igvc_self_drive_sim` repository were released into the `melodic` distro by running `/usr/bin/bloom-release igvc_self_drive_sim --rosdistro melodic` on `Sun, 07 Oct 2018 03:06:44 -0000`
...
## igvc_self_drive_sim (kinetic) - 0.1.3-0

The packages in the `igvc_self_drive_sim` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release igvc_self_drive_sim --rosdistro kinetic` on `Sun, 07 Oct 2018 02:47:01 -0000`
...
## igvc_self_drive_sim (melodic) - 0.1.3-0

The packages in the `igvc_self_drive_sim` repository were released into the `melodic` distro by running `/usr/bin/bloom-release igvc_self_drive_sim --rosdistro melodic` on `Sun, 07 Oct 2018 02:44:39 -0000`
...
## igvc_self_drive_sim (melodic) - 0.1.2-0
